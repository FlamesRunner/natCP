...
$ath = $dbh->prepare('SELECT * from virtualservers LIMIT 5 OFFSET '.($_GET['pagenum']*5-5));

}
} else {
$ath = $dbh->prepare('SELECT * from virtualservers LIMIT 5 OFFSET 1');
}
$ath->execute();
...
if ($_GET['act']==='terminatearea'){

echo '<a href="manage.php?vserver='.$_GET['vserver'].'&act=destroy" class="btn btn-danger">Terminate</a>';
